...
export function Header({ onLogoClick, onLoginClick, onAdminClick, onLogout, isAuthenticated, onNavigateToProducts, onNavigateToProjects, onNavigateToSection }: HeaderProps) {
